                    ...
                    <Card style ={{width:"93%"}}>
                        <Article>
                            ...
                            <Paragraph>
                                ...
                                carefully before using dashboard specific functionalities. Add description of our web application , main objective, etc.
                            </Paragraph>
                            <Paragraph>
                                Add some relevant information about ENDORSE
                            </Paragraph>
                            <Sub_Title>Services that you can use in our Dashboard:</Sub_Title>
                            <Paragraph>
